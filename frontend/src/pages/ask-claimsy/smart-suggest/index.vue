<template>
  <div class="mx-auto my-8 w-full max-w-6xl bg-gray-100">
    ...
    <div
      ...
      <div
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink to="/ask-claimsy/smart-suggest/travel-transport" class="focus:outline-hidden">
          ...
          <p class="mt-2 text-sm text-gray-500">
            Book flights, hotels, and transport for your business trip
          </p>
        </div>
        <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-theme-300"
          aria-hidden="true">
      ...
      <div
        class="group relative bg-white p-6 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-inset sm:rounded-tr-lg">
        <div>
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink to="/ask-claimsy/smart-suggest/meals-entertainment" class="focus:outline-hidden">
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
              Meals & Entertainment
            </RouterLink>
          ...
          <p class="mt-2 text-sm text-gray-500">
            Find restaurants, food delivery, and local entertainment
          </p>
        </div>
        <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-theme-300"
          aria-hidden="true">
      ...
      <div
        class="group relative bg-white p-6 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-inset sm:rounded-bl-lg">
        <div>
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink to="/ask-claimsy/smart-suggest/health-wellness" class="focus:outline-hidden">
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
              Health & Wellness
            </RouterLink>
          ...
          <p class="mt-2 text-sm text-gray-500">
            Access healthcare, fitness, and wellness services
          </p>
        </div>
        <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-theme-300"
          aria-hidden="true">
      ...
      <div
        class="group relative rounded-br-lg rounded-bl-lg bg-white p-6 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-inset sm:rounded-bl-none">
        <div>
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink to="/ask-claimsy/smart-suggest/others" class="focus:outline-hidden">
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
              Miscellaneous
            </RouterLink>
          ...
          <p class="mt-2 text-sm text-gray-500">
            Handle various business needs like office supplies, professional services, and other expenses
          </p>
        </div>
        <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-theme-300"
          aria-hidden="true">
