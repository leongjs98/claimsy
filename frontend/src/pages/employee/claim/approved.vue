        ...
        <div class="min-w-full py-2 align-middle sm:px-6 lg:px-8">
          ...
          >
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr
                v-for="(expense, index) in sortedApprovedExpenses"
                :key="expense.Id"
                class="shadow-md"
              >
                <td
                  :class="[
                    ...
                    index === sortedApprovedExpenses.length - 1
                      ? 'rounded-bl-lg'
                      : '',
                  ]"
                >
...
<script setup>
  ...
  const sortedApprovedExpenses = computed(() => {
    ...
    return sortedExpenses.filter(
      (sortedExpenses) => sortedExpenses.Status.toLowerCase() === "approved",
    );
  });
