                ...
                <tr v-if="sortedRejectedClaims.length === 0" class="shadow-md">
                  <td colspan="7" class="py-8 text-center text-gray-500 rounded-b-lg">
                    <div class="flex flex-col items-center space-y-2">
                      ...
                      <p class="text-lg font-medium">No rejected claims found</p>
                      <p class="text-sm">All your claims are either approved or pending review.</p>
                    </div>
                  </td>
                </tr>
                ...
                >
                  <td
                    :class="[
                      ...
                      index === sortedRejectedClaims.length - 1 ? 'rounded-bl-lg' : '',
                    ]"
                  >
                    {{ index + 1 }}
                  </td>
                  ...
                  <td
                    :class="[
                      ...
                      index === sortedRejectedClaims.length - 1 ? 'rounded-br-lg' : '',
                    ]"
                  >
                    <button
