<template>
  <div class="mx-auto my-14 w-full max-w-6xl bg-gray-100">
    <div class="mx-auto max-w-3xl">
      <div class="hover:shadow-3xl transform overflow-hidden rounded-xl bg-white px-20 py-6 shadow-2xl transition-all">
        <!-- Card Header -->
          ...
          <div
            ...
            <div class="text-center">
              ...
              <div class="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-blue-100">
                <svg class="h-10 w-10 text-theme-100" fill="none" stroke="currentColor" viewBox="0 0 24 24"
              ...
              <div class="mt-4 flex flex-col items-center justify-center space-y-3">
                ...
                <label
                  ...
                  <span class="flex items-center justify-center px-3 py-2 text-center text-xs">Browse Files</span>
                  <input type="file" class="sr-only" @change="handleFileInput" accept=".pdf,.jpg,.jpeg,.png" multiple />
                </label>
              </div>
            </div>

            <!-- Preview section with enhanced styling -->
            <div v-if="selectedFiles.length > 0" class="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
              <div v-for="(file, index) in selectedFiles" :key="file.name + file.size + index"
                class="flex items-center justify-between py-2"
                :class="{ 'border-b border-gray-200': index < selectedFiles.length - 1 }">
