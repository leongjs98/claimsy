<template>
  <div class="mx-auto my-8 w-full max-w-5xl bg-gray-100">
    <Tab
      :tabs="[
        {
          link: '/employee/claimsy-ask/',
          routeName: 'Chat with Claimsy',
        },
        {
          link: '/employee/claimsy-ask/smart-suggest/',
    ...
    >
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/employee/claimsy-ask/smart-suggest/travel-transport"
        ...
        <span
          class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-theme-300"
          aria-hidden="true"
        >
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/employee/claimsy-ask/smart-suggest/meals-entertainment"
              class="focus:outline-hidden"
            >
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/employee/claimsy-ask/smart-suggest/health-wellness"
              class="focus:outline-hidden"
            >
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/employee/claimsy-ask/smart-suggest/miscellaneous"
              class="focus:outline-hidden"
            >
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
