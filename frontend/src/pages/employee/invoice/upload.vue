<template>
  ...
  <div class="p-2">
      ...
      >
        ...
        <div class="flex items-center space-x-2">
          <button
            ...
            class="p-1 rounded-full text-blue-600 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            title="View Receipt"
          >
          ...
          <button
            ...
            class="p-1 rounded-full text-red-600 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
            title="Remove File"
          >
            ...
            <svg
              ...
              class="h-5 w-5"
            >
              <path stroke-linecap="round" stroke-linejoin="round" d="M6 7h12M9 7V5a3 3 0 0 1 6 0v2m-9 0h12v12a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V7z" />
    ...
    <v-dialog v-model="showModal" width="850" height="1000" >
      <v-card class="rounded-lg shadow-lg flex flex-col h-full">
        <div class="flex items-center justify-between px-8 mt-6">
          ...
          <button
            @click="closeModal"
            class="ml-2 flex items-center justify-center rounded-full hover:bg-red-600 p-1"
        ...
        <div class="p-6 items-center justify-center overflow-auto flex-1">
          <iframe
            v-if="currentViewedFile?.type === 'image' && currentViewedFile?.previewUrl"
            :src="currentViewedFile.previewUrl"
            class="w-full h-full rounded"
          ></iframe>
          <iframe
            v-else-if="currentViewedFile?.type === 'pdf' && currentViewedFile?.previewUrl"
            :src="currentViewedFile.previewUrl"
...
<script setup>
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      alert("LLM analysis unsuccessful. Please try again or upload different files.");
    } finally {
