  ...
  <div class="mx-auto my-8 w-full max-w-5xl bg-gray-100">
    <Tab
      :tabs="[
        ...
        {
          link: '/admin/ask-claimsy/smart-suggest/',
    ...
    >
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/admin/ask-claimsy/smart-suggest/travel-transport"
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/admin/ask-claimsy/smart-suggest/meals-entertainment"
              class="focus:outline-hidden"
            >
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/admin/ask-claimsy/smart-suggest/health-wellness"
              class="focus:outline-hidden"
            >
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
      ...
      >
        ...
        <div class="mt-8">
          <h3 class="text-base font-semibold text-gray-900">
            <RouterLink
              to="/admin/ask-claimsy/smart-suggest/supplies_and_equipments"
              class="focus:outline-hidden"
            >
              <!-- Extend touch target to entire panel -->
              <span class="absolute inset-0" aria-hidden="true"></span>
