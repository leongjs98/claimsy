  ...
  <div class="px-4 sm:px-6 lg:px-16">
    ...
    <div class="mt-16 sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">
          A list of all the Employees in your account including their ID, tukar,
          Date, Item(s), Email, Total (RM), Details.
        </p>
      </div>
    ...
    <div class="mt-8 flow-root">
      <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
        <div
          class="shadow-black-900 inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8"
        >
          <div class="blue-xl/20 shadow-sm ring-1 ring-black/5 sm:rounded-lg">
            <table class="min-w-full divide-y divide-gray-300 shadow-xl/20">
              <thead class="bg-blue-900">
                <tr>
                  <th
                    scope="col"
                    class="py-3.5 pr-3 pl-4 text-left text-sm font-semibold text-red-50 sm:pl-6"
                  >
                    ID
                  </th>
                  <th
                    scope="col"
                    class="px-3 py-3.5 text-left text-sm font-semibold text-red-50"
                  >
                    Name
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    class="px-3 py-3.5 text-right text-sm font-semibold text-red-50"
                  >
                    Total (RM)
                  </th>
                  <th
                    scope="col"
                    class="px-3 py-3.5 text-center text-sm font-semibold text-red-50"
                  >
                    Details
                  </th>
                  <!-- <th scope="col" class="relative py-3.5 pl-4 pr-3 sm:pr-6 text-right">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="person in people" :key="person.email">
                  ...
                  <td
                    class="px-3 py-4 text-center text-sm whitespace-nowrap text-red-500"
                  >
                    <img
