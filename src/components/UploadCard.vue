            ...
            <div class="text-center">
              ...
              <div class="mt-4 flex flex-col items-center justify-center space-y-3">
                ...
                <label
                  ...
                  <input type="file" class="sr-only" @change="handleFileInput" accept=".pdf,.jpg,.jpeg,.png" />
                </label>
              </div>
            </div>

            <!-- Preview section with enhanced styling -->
            <div v-if="selectedFile" class="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
          ...
          <div class="mt-6 flex justify-center space-x-10">
            ...
            <button @click="uploadFile" :disabled="!selectedFile"
              ...
              <span class="flex items-center">
                <svg v-if="isUploading" class="mr-2 -ml-1 h-4 w-4 animate-spin text-white"
